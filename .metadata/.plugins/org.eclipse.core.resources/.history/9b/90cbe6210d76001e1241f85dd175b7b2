 ...
 * Set_Up_Clear_Down
 */
#define Compare_Output_Mode_A			OC1_disconnected
/****************************************************************************************/
 ...
 * Set_Up_Clear_Down
 */
#define Compare_Output_Mode_B			OC1_disconnected
/****************************************************************************************/
 ...
 * T1_ENABLE
 */
#define Input_Capture_Interrupt_STATUS					T1_ENABLE
#define Output_Compare_A_Match_Interrupt_STATUS			T1_ENABLE
#define Output_Compare_B_Match_Interrupt_STATUS			T1_ENABLE
#define Overflow_Interrupt_STATUS						T1_ENABLE
/****************************************************************************************/
