...
void TIMER0_voidInitialize(){
	...
	TIMSK0->TOIE0 = Overflow_Interrupt_Status;
	TIMSK0->OCIE0 = Compare_Match_Interrupt_Status;
...
void TIMER0_voidSetPWM(u8 Copy_u8DutyCycle){

	u8 OCR0_value;

	OCR0_value = Mapping_u16Map(Copy_u8DutyCycle,0,100,0,255);

	TIMER0_voidSetOCR0(OCR0_value);
}
